...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React9.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React9.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React9.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getItemDomElement = React9.useCallback((itemId) => {
  ...
  const reducerActionContext = React9.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
function MenuProvider(props) {
  ...
  const listContextValue = React10.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React10.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
...
var TransitionContext = React12.createContext(null);

// node_modules/@mui/base/useTransition/useTransitionStateManager.js
function useTransitionStateManager() {
  const transitionContext = React13.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React14.useState(true);
  const hasPendingExitTransition = React14.useRef(false);
  const registeredTransitions = React14.useRef(0);
  const [hasTransition, setHasTransition] = React14.useState(false);
  const previousRequestEnter = React14.useRef(requestEnter);
  React14.useEffect(() => {
  ...
  const handleExited = React14.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React14.useCallback(() => {
...
var PopupContext = React15.createContext(null);
...
var Popup = React16.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React16.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React17.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React18.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React19.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
var InnerMenuItem = React22.memo(React22.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
...
var MenuItem2 = React22.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React25.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React25.useMemo(() => {
    return {
      min: min3,
      max: max3,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React25.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var InnerOption = React28.memo(React28.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React28.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var Select = React32.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime24.jsxs)(React32.Fragment, {
...
var Slider = React34.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime25.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime25.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime26.jsxs)(React34.Fragment, {
...
var Snackbar = React36.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React38.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React39.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React40.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabsContext() {
  const context = React42.useContext(TabsContext);
  if (context == null) {
...
var Tabs = React44.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
var TabPanel = React46.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var TabsList = React49.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var Tab = React51.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
var TextareaAutosize = React52.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  return (0, import_jsx_runtime41.jsxs)(React52.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6UWMSBFT.js.map
